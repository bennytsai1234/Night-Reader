...
- 修復滾動漸進式卡頓與 fling 撞牆：RenderHybridBlockSliver 以 Fenwick 取代框架 O(n) 線性掃描、governor ballistic gate 改工作時間且赤字不歸零、physics 即時摩擦＋赤字高摩擦滑行、行查詢/epoch 換代/磁碟寫入衛生；analyze 與 705 tests 全綠。
